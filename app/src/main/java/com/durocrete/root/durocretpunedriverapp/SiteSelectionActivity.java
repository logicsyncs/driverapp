...
import com.durocrete.root.durocretpunedriverapp.adapter.SiteSelectionDeliveryAdapter;
...
public class SiteSelectionActivity extends AppCompatActivity {
    private static String TAG = SiteSelectionActivity.class.getSimpleName();
    ...
    private SiteSelectionDeliveryAdapter sitesSelectionDeliveryAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mActivity = SiteSelectionActivity.this;
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SiteSelectionActivity.this, LoginActivity.class);
        ...
        history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SiteSelectionActivity.this, SummaryActivity.class);
                startActivity(intent);
                finish();
            }
        });
...
//        btnSubmit = (Button) findViewById(R.id.btnSubmit);
        sitesSelectionDeliveryAdapter = new SiteSelectionDeliveryAdapter(this, new ArrayList<SiteDetailModel>());
...
//                }
    ...
    private void checkLocationPermission() {
        if (Build.VERSION.SDK_INT >= M) {
            if (ContextCompat.checkSelfPermission(SiteSelectionActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
    ...
    private void checkALLPermission() {
        ...
        if (ContextCompat.checkSelfPermission(SiteSelectionActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SiteSelectionActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {

                // Show an explanation to the user *asynchronously* -- don't block
                // this thread waiting for the user's response! After the user
                // sees the explanation, try again to request the permission.
                new androidx.appcompat.app.AlertDialog.Builder(SiteSelectionActivity.this)
    ...
    private void makeSideRequest() {
        ...
        sitesSelectionDeliveryAdapter.clearAdapter();
...
//            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
                    ...
                    sitesSelectionDeliveryAdapter.setArray(sideObjectArrayList);
                    recyclerSideview.setAdapter(sitesSelectionDeliveryAdapter);
                } else {
